...
if HAS_TORCH:
    ...
    class KV14Model(nn.Module):
        ...
        def __init__(self, config: KV14Config):
            ...
            self.bug_head = nn.Linear(config.hidden_size, 1)
            self.security_head = nn.Linear(config.hidden_size, 10)
    ...
    # Offline stubs when torch not available
    class RMSNorm: pass
    class SwiGLU: pass
    class KV14DecoderLayer: pass
    class KV14Model:
